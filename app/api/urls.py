...
router.register(r'user-other-badges', UserOtherBadgeViewSet, basename='user-other-badges')
router.register(r'user-all-badges', UserAllBadgeViewSet, basename='user-all-badges')
